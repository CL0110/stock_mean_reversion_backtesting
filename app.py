...
with st.expander("ℹ️ About yfinance"):
    st.markdown("""
    **yfinance** is a popular open-source Python library that allows users to easily download historical, 
    real-time, and fundamental financial data from Yahoo Finance. It provides a simple, pandas-compatible 
    interface to access stock prices, dividends, splits, and company information for analysis and research, 
...
with st.spinner("Loading backtest results..."):
    ...
    # ── 1. Cumulative Portfolio Value (main chart) ──────────────────────────
